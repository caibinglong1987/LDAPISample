...
import cn.eas.national.ldapisample.device.SIM4442CardReaderImpl;
import cn.eas.national.ldapisample.presenter.ISIMCardPresenter;
...
public class SIM4442CardPresenterImpl implements ISIMCardPresenter {
    private static final byte[] SC_PWD = ByteUtil.str2BCD("b62307");//new byte[]{ 0x01, 0x02, 0x03 };
    private static final int READ_LENGTH = 100;//5;
    private static final int ADDRESS = 0;//22;
